...
#define m12 7     // left motor
#define m21 6     // right motor
#define m22 5     // right motor

// for arm
#define m31 12      // for up-down
#define m32 11      // for up-down
#define m41 10     // for open-close
#define m42 9    // for open-close

// for ultrasonic sensor
#define trig 0    // trigger pin
